...
InvisibleRecoFrame* RestFramesHelper::addInvisibleFrame(const std::string &name){
...
InvisibleJigsaw* RestFramesHelper::addInvisibleJigsaw(const std::string &name, InvJigsawType type){
...
MinMassesCombJigsaw* RestFramesHelper::addCombinatoricJigsaw(const std::string &name, CombJigsawType type){
...
CombinatoricGroup* RestFramesHelper::addCombinatoricGroup(const std::string &name){
  CombinatoricGroup* group = new CombinatoricGroup(name,name);

  m_Objects.push_back(group);
  m_CombGroups[name] = group;return group;
...
InvisibleRecoFrame* RestFramesHelper::getInvisibleFrame(const std::string &name){
...
MinMassesCombJigsaw* RestFramesHelper::getCombinatoricJigsaw(const std::string &name){
